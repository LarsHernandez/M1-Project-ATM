...
# This part requires you have run the datamanagement parts of the script, or you can find the data in the github repository
...
load(url("https://github.com/thefactmachine/hex-binning-gis-data/raw/master/popDensity.RData"))
```
...
|               |               | (Kmeans)      |
| ------------- |:-------------:| -------------:|
| Continuous    | Regression    | Dim.reduction |
|               |               | (PCA)         |
